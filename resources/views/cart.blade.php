...
@section('content')
    <div class="cart-content">
        <div class="main-content">
            ...
            <form action="{{ route('cart.pay') }}" method="POST" enctype="multipart/form-data" class="auth-form">
                @csrf
                <div class="form-group">
                    <label for="number_card">Номер карты</label>
                    <input type="text" name="number_card" placeholder="0000 0000 0000 0000" maxlength="19" required>
                </div>
                <div class="form-group">
                    <label for="owner">Владелец (как на карте)</label>
                    <input type="text" name="owner" placeholder="IVAN IVANOV" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cvc_code" placeholder="000" maxlength="3" required>
                </div>
                <div class="form-group">
