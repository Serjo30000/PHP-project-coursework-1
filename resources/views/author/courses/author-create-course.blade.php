    ...
    <div class="form-container">
        ...
        <form action="{{ route('author.courses.store') }}" method="POST" enctype="multipart/form-data" class="teacher-form">
            ...
            <div class="form-group">
                ...
                <input type="number" name="count_online_classes" value="{{ old('count_online_classes', $course->count_online_classes ?? '') }}" min="1" placeholder="Введите кол-во нлайн занятий" required>
            </div>
            <div class="form-group">
